                                ...
                                <div class="card" style="box-shadow: 0px 0.298734px 1.19494px rgba(0, 0, 0, 0.25);">
                                    <div class="card-body">
                                        ...
                                        <div class="row" style="margin-top: 10rem;">
                                            <div class="col text-center">
                                                <svg width="156" height="53" viewBox="0 0 156 53" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <circle cx="128.954" cy="26.3769" r="26.3769" fill="#00C305"/>
                                                    <path d="M120.049 36.695V17.2547C120.049 16.8416 120.186 16.4401 120.439 16.1133C120.691 15.7865 121.046 15.553 121.446 15.4493C121.846 15.3457 122.269 15.3778 122.648 15.5407C123.028 15.7036 123.343 15.9879 123.543 16.3491L134.311 35.7326C134.512 36.0938 134.827 36.3782 135.206 36.5411C135.586 36.7039 136.009 36.7361 136.409 36.6324C136.809 36.5288 137.163 36.2952 137.416 35.9685C137.669 35.6417 137.806 35.2402 137.806 34.827V15.3867" stroke="white" stroke-width="3.55139" stroke-linecap="round" stroke-linejoin="round"/>
                                                    <path d="M116.497 22.4902H141.357" stroke="white" stroke-width="3.55139" stroke-linecap="round" stroke-linejoin="round"/>
                                                    <path d="M116.497 29.5918H141.357" stroke="white" stroke-width="3.55139" stroke-linecap="round" stroke-linejoin="round"/>
                                                    <path d="M88.3802 22.5625L67.407 22.5625" stroke="#C1C7CF" stroke-width="2.62165" stroke-linecap="round" stroke-linejoin="round"/>
                                                    <path d="M88.3804 22.5625L79.2046 13.3867" stroke="#C1C7CF" stroke-width="2.62165" stroke-linecap="round" stroke-linejoin="round"/>
                                                    <path d="M67.4076 29.1133L88.3809 29.1133" stroke="#C1C7CF" stroke-width="2.62165" stroke-linecap="round" stroke-linejoin="round"/>
                                                    <path d="M76.5837 38.291L67.408 29.1152" stroke="#C1C7CF" stroke-width="2.62165" stroke-linecap="round" stroke-linejoin="round"/>
                                                    <circle cx="26.3769" cy="26.3788" r="26.3769" fill="#5896FD"/>
                                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M28.1355 12.0163C28.1355 11.5499 27.9502 11.1026 27.6204 10.7729C27.2907 10.4431 26.8434 10.2578 26.377 10.2578C25.9106 10.2578 25.4634 10.4431 25.1336 10.7729C24.8038 11.1026 24.6185 11.5499 24.6185 12.0163V13.7747C22.7531 13.7747 20.964 14.5158 19.6449 15.8349C18.3258 17.154 17.5847 18.9431 17.5847 20.8086C17.5847 22.674 18.3258 24.4631 19.6449 25.7822C20.964 27.1013 22.7531 27.8424 24.6185 27.8424V34.8762C23.8911 34.8763 23.1816 34.651 22.5875 34.2312C21.9934 33.8115 21.5441 33.2179 21.3012 32.5322C21.1398 32.1006 20.8155 31.7495 20.3979 31.5546C19.9803 31.3597 19.503 31.3365 19.0685 31.49C18.634 31.6435 18.2771 31.9614 18.0746 32.3753C17.8721 32.7892 17.8401 33.2661 17.9856 33.7033C18.4708 35.0748 19.3691 36.2622 20.557 37.1021C21.7448 37.9419 23.1638 38.393 24.6185 38.3931V40.1516C24.6185 40.618 24.8038 41.0652 25.1336 41.395C25.4634 41.7248 25.9106 41.9101 26.377 41.9101C26.8434 41.9101 27.2907 41.7248 27.6204 41.395C27.9502 41.0652 28.1355 40.618 28.1355 40.1516V38.3931C30.001 38.3931 31.79 37.6521 33.1091 36.333C34.4282 35.0139 35.1693 33.2248 35.1693 31.3593C35.1693 29.4938 34.4282 27.7047 33.1091 26.3856C31.79 25.0665 30.001 24.3255 28.1355 24.3255V17.2916C28.8629 17.2915 29.5724 17.5169 30.1665 17.9366C30.7606 18.3564 31.21 18.95 31.4528 19.6357C31.6142 20.0673 31.9385 20.4183 32.3561 20.6132C32.7737 20.8081 33.251 20.8314 33.6856 20.6779C34.1201 20.5244 34.477 20.2065 34.6795 19.7926C34.882 19.3786 34.9139 18.9018 34.7684 18.4645C34.2832 17.0931 33.3849 15.9057 32.197 15.0658C31.0092 14.2259 29.5902 13.7749 28.1355 13.7747V12.0163ZM24.6185 17.2916C23.6858 17.2916 22.7913 17.6622 22.1317 18.3217C21.4722 18.9813 21.1016 19.8758 21.1016 20.8086C21.1016 21.7413 21.4722 22.6358 22.1317 23.2954C22.7913 23.9549 23.6858 24.3255 24.6185 24.3255V17.2916ZM28.1355 27.8424V34.8762C29.0682 34.8762 29.9628 34.5057 30.6223 33.8461C31.2818 33.1866 31.6524 32.2921 31.6524 31.3593C31.6524 30.4266 31.2818 29.532 30.6223 28.8725C29.9628 28.2129 29.0682 27.8424 28.1355 27.8424Z" fill="white"/>
                                                    </svg>
                                        ...
                                        <div class="row mt-3">
                                            <div class="col text-center">
                                                <h1>Welcome</h1>
                                                <p>To the Dollar to Naira dashboard</p>
                                            </div>
                                        </div>

                                        <div class="row" style="margin-bottom: 10rem;">
                                            <div class="col text-center">
                                                <a  href="{{url('/dashboard/p2p/foreign/2')}}" class="btn px-5 mx-2" style="background: #2A8BF2; border: 1px solid #2A8BF2; box-sizing: border-box;border-radius: 30px; color: #fff;">Continue</a>
                                            </div>
                                        </div>
            ...
            <div class="alert alert-error bg-danger" id="input_rate_error" style="display: none;">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="number" min="0.01" name="dollar_amount" id="dollar_amount_input_rate" class="form-control input_rate_continuex border border-left-0" value="1" min="1" placeholder="Example: $2000" style="padding: .6rem .05rem;">
                    </div>
                </div>
                <div class="form-group">
        ...
        <div class="modal-body p-5">
            ...
            <form id="lu_connect_form">
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" name="dollar_rate" id="dollar_rate_connect_lu_hidden">
                    
                </div>
                <div class="row mt-5">
                    <div class="col text-center">
                        <button class="btn btn-primary px-5" style="background: #2A8BF2; border: 1px solid #2A8BF2; box-sizing: border-box;border-radius: 30px;">Buy Now</button>
                    </div>
                </div>
            </form>
        ...
        <div class="modal-body">
            ...
            <div class="row mt-5 mb-4">
                <div class="col text-center">
                    ...
                    <a id="pay_now_btn" href="javascript:void" class="btn px-5 mx-2" style="background: #2A8BF2; border: 1px solid #2A8BF2; box-sizing: border-box;border-radius: 30px; color: #fff;">Pay Now</a>
                </div>
            </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="row mt-3">
                <div class="col">
                    <a href="javascript:void" id="bank_transfer_lu" class="btn btn-sm pl-5" style="border: 1px solid lightgray;">
            ...
            <div class="row mt-3 mb-4">
                <div class="col">
                    <a href="javascript:void" class="btn btn-sm pl-5" style="border: 1px solid lightgray;">
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-body p-5">
            ...
            <div class="row mt-5">
                <div class="col text-center">
                    <a href="javascript:void" class="btn btn-outline-light closemodal1b" style="border: 1px solid #3E7BFA52; box-sizing: border-box;border-radius: 30px; color: #3E7BFA52; padding-left: 3.5rem; padding-right: 3.5rem;">Cancel</a>
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="row mt-3 mb-4">
                <div class="col">
                    <a href="javascript:void{{-- route('cardpayment.pay')--}}" class="btn btn-sm pl-5" style="border: 1px solid lightgray;">
                        <p class="text-left py-0 my-0">Pay via Wallet</p>
                        <small class="text-left text-muted">Fund your payHelpa wallet using verve, naira mastercard or visa debit card</small>
                    </a>
                </div>
        ...
        <div class="modal-body">
            ...
            <div class="row mt-5 mb-4">
                <div class="col-lg-4 text-center">
                    <a href="javascript:void" class="btn btn-outline-light mx-2 closemodal1e" style="border: 1px solid #3E7BFA52; box-sizing: border-box;border-radius: 30px; color: #3E7BFA52; padding-left: 3.5rem; padding-right: 3.5rem;">Cancel</a>
                </div>
                <div class="col-lg-8">
        ...
        <div class="modal-body">
            ...
            <div class="row mt-4">
                ...
                <div class="col text-right">
                        ...
                        <h4 class="text-right text-dark">
                            <span id="account_number_box2">7894456332</span>
        ...
        <div class="modal-body">
            ...
            <div class="row mt-5 mb-4">
                ...
                <div class="col-lg-8 text-center">
                    <form id="made_transfer_form">
                        <input type="hidden" name="dollar_rate" id="dollar_rate_releasing_lu">
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <form id="card_pay_form" styfle="margin-top:4rem">
                                ...
                                <div class="form-group">
                                    <label for="">Card Number</label>
                                    <input type="hidden" name="dollar_rate" class="dollar_rate_releasing_lu">
            ...
            <div class="modal-body">
                ...
                <div class="row py-5">
                    <div class="col text-center">
                        ...
                        <p class="mt-3" style="font-style: normal; font-weight: 400; font-size: 16px; line-height: 25.57px; text-align: center; color: #979797">Kindly wait for a Helpa to accept your rate.</p>

                        <a class="btn btn-primary px-5 mt-2 text-white" style="background: #2A8BF2; border: 1px solid #2A8BF2; box-sizing: border-box;border-radius: 30px;">View  details</a>
                    </div>
                    </div>
