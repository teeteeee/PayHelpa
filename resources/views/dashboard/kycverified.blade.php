                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row" style="margin-top: 8rem; margin-bottom: 10rem;">
                                        <div class="col text-center">
                                            ...
                                            <h4 class="mt-5" style="font-style: normal; font-weight: 600; font-size: 36px; line-height: 43.57px; text-align: center; color: #231F20;">Your account has been verified</h4>
                                            <p class="mt-3" style="font-style: normal; font-weight: 400; font-size: 16px; line-height: 25.57px; text-align: center; color: #979797">If you would want to update a new information, kindly click on the button.</p>

                                            <a href="javascript:void" class="btn btn-primary px-5 mt-2" style="background: #2A8BF2; border: 1px solid #2A8BF2; box-sizing: border-box;border-radius: 30px;">Update KYC</a>
                                        </div>
                                      </div>
