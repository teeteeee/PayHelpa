                                        ...
                                        <div class="row mb-1">
                                            <div class="col-md-12">
                                                ...
                                                <div class="row pt-3 px-3 pb-0">
                                                    <div class="col">
                                                        <a class="cursor mx-3" style="color: #979797" href="{{ route('status')}}">All</a>  <a class="cursor mx-3 text-dark" href="{{ route('status.pending')}}">Pending</a> <a class="cursor mx-3" style="color: #979797" href="{{ route('status.ongoing')}}">Ongoing</a> <a class="cursor mx-3" style="color: #979797" href="{{ route('status.completed')}}">Completed</a> 
