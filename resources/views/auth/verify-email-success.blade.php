<html lang="en">
<head>
  <title>PayHelpa Email Verification Success</title>
  <meta charset="utf-8">
...
<div class="container">
  ...
  <div class="row" style="margin-top: 9rem;">
    <div class="col text-center">
        ...
        <h1 class="mt-2" style="font-style: normal; font-weight: 600; font-size: 22px; line-height: 43.57px; text-align: center; color: #231F20;">Thanks for verifying your email</h1>
        <p style="font-style: normal; font-size: 16px; line-height: 25.57px; text-align: center; color: #979797">Your email has been verified.</p>
    </div>
  </div>

    <div class="row mt-1 mx-auto text-center">
