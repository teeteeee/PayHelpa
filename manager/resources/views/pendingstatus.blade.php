...
<tbody>
	...
	<tr>
		...
		<td>N{{number_format($key->rate,2)}}</td>
		<td>${{number_format($key->amount_requested,2)}}</td>
		
		<td><a href="{{route('pendinginfo',$key->transaction_id)}}" class="btn btn-outline-primary mr-2"></i>View </a></td>
