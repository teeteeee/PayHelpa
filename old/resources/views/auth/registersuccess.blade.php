...
<div class="container">
  ...
  <div class="row" style="margin-top: 5rem;">
    <div class="col text-center">
        ...
        <h1 style="font-style: normal; font-weight: 600; font-size: 36px; line-height: 43.57px; text-align: center; color: #231F20;">Awesome!</h1>
        <p style="font-style: normal; font-weight: 400; font-size: 20px; line-height: 25.57px; text-align: center; color: #979797">Registration successful. Please check your <br> email for activation link</p>
    </div>
  </div>
