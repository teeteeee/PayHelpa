...
<div class="container">
  ...
  <div class="row" style="margin-top: 3rem;">
    <div class="col text-center">
        <h1 style="font-style: normal; font-weight: 600; font-size: 32px; line-height: 43.57px; text-align: center; color: #231F20;">Welcome to your peer to <br> peer trading platform.</h1>
    </div>
  </div>
      ...
      <div class="col-md-12">
        ...
        <form method="POST" action="{{ route('register') }}">
          ...
          <div class="form-group name-box mt-5" style="width: 90%; margin:auto;">
            ...
            <label for="email" class="text-right" style="font-weight: 400; font-size: 18px;  text-align: center; color: #303030;">Full Name</label>
            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}" placeholder="Last & First Name" required>
              @error('name')
              ...
              <div class="form-group password-box mt-4" style="width: 90%; margin:auto;">
                ...
                <div class="input-group mb-3">
                  ...
                  <input id="password" type="password" class="form-control @error('password') is-invalid @enderror border border-right-0" name="password" value="{{ old('password') }}" required autocomplete="current-password" placeholder="Please enter your password">
              ...
              <div class="row">
                <div class="col text-center">
                  <button type="submit" class="btn text-white py-2 my-3" style="font-style: normal; font-size: 12px; line-height: 16px; background:#3E7BFA;">CREATE ACCOUNT</button>
                </div>
              </div>
