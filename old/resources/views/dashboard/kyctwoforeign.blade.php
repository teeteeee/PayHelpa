                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row" style="margin-top: 5rem;">
                                        <div class="col text-center">
                                            ...
                                            <p style="font-style: normal; font-weight: 600; font-size: 18px; line-height: 22px; text-align: center; color: #979797;">So that we can help you with a better experience</p>
                                        </div>
                                    </div>

                                    <form action="{{ url('verify/phone/foreign')}}" method="post">
                                        @csrf
                                        <div class="row mt-5">
