                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-5 mx-auto">
                                                ...
                                                <h1 class="text-center" style="margin-top: 8rem;">Great! You are here.</h1>
                                                ...
                                                <form action="{{url('add/foreign/user/rate')}}" method="POST">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input type="number" step="0.01" name="rate" class="form-control border border-left-0" min="1" placeholder="Example: ₦389" value="{{$user->rate}}" style="padding: .6rem .05rem;" required>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col">
                                                                ...
                                                                <div class="input-group mb-3">
                                                                    ...
                                                                    {{-- <input type="number" step="0.01" name="min_amount" class="form-control border border-left-0" min="1" placeholder="Example: $500" value="{{$user->min_amount}}" style="padding: .6rem .05rem;" required> --}}
                                                        ...
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <span class="input-group-text bg-white border border-right-0" style="padding: .6rem .1rem; padding-left: .7rem">$</span>
                                                             ...
                                                             <select name="max_amount" class="form-control" required>
                                                                ...
                                                                <option value="9000.00" <?php if($user->min_amount == 9000.00){ echo "selected"; } ?>>9000</option>
                                                                <option value="9500.00" <?php if($user->min_amount == 9500.00){ echo "selected"; } ?>>9500</option>
                                                                <option value="10000.00" <?php if($user->min_amount == 10000.00){ echo "selected"; } ?>>10000</option>
                                                            </select>
                                                        </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row mt-5">
                                                        <div class="col text-center">
                                                            <button class="btn btn-primary px-5" style="background: #2A8BF2; border: 1px solid #2A8BF2; box-sizing: border-box;border-radius: 30px;">Add Rate</button>
                                                        </div>
                                                    </div>
                                                </form>
