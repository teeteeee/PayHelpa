...
<table class="datatable table table-stripped">
    <a href="{{route('localUsersStatus')}}" class="btn btn-outline-primary ">Local Users</a>

    <a href="{{route('foreignUsersStatus')}}" class="me-5 btn btn-outline-primary justify-content-center">Foreign Users</a>
