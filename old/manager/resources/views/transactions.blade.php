...
<div class="d-flex justify-content-center">
      <a href="#" class='btn btn-outline-primary mr-2'>Foreign Transactions</a>
      <a href="#" class='btn btn-outline-primary mr-2'>Local Transactions</a>
...
<th class="text-right">Action</th>
	...
	<tr>		
		...
		<td>${{number_format($key->amount)}}.00</td>
		<td>{{$key->rate}}</td>
	<td ></td>
